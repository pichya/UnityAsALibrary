...
- (void)viewDidLoad
{
    ...
    self.unityInitBtn.center = CGPointMake(50, 520);
    ...
    self.unpauseBtn.center = CGPointMake(150, 520);
    ...
    self.unloadBtn.center = CGPointMake(250, 520);
    ...
    self.quitBtn.center = CGPointMake(250, 570);
...
- (void)initUnity
{
    ...
    if(self.showUnityOffButton == nil) {
        ...
        self.showUnityOffButton.center = CGPointMake(50, 520);
        ...
        self.btnSendMsg.center = CGPointMake(150, 520);
